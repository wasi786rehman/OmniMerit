...
namespace Omnimerit_Portal.Employee
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Index(Omnimerit.Data.Model.Database.Login log)
        {
        ...
        public JsonResult GetExcelData(string Cour, string batch, int subj)
        {
